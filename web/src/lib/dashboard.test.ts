...
const jobs: Job[] = [
  {
    ...
    description: '', rawSeniority: '', score: 21, status: 'new', firstSeen: 'r1', lastSeen: 'r1', runId: 'r1', matchedSkills: ['python'],
  },
  {
    ...
    description: '', rawSeniority: '', score: 15, status: 'applied', firstSeen: 'r0', lastSeen: 'r1', runId: 'r1', matchedSkills: ['pytorch'],
  },
  {
    ...
    description: '', rawSeniority: '', score: 35, status: 'rejected', firstSeen: 'r0', lastSeen: 'r1', runId: 'r1', matchedSkills: ['python'],
  },
]

const base = { query: '', workplace: 'all', source: 'all', status: 'all', sort: 'score' as const }
